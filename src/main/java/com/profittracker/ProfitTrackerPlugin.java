...
import com.profittracker.support.di.LeagueServiceModule;
...
public class ProfitTrackerPlugin extends Plugin
{
    ...
    {
        // DI
        Injector childInjector = injector.createChildInjector(new HttpAdapterModule(), new ScreenshotModule(), new LeagueServiceModule());
